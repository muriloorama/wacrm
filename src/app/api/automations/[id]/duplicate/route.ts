...
export async function POST(
  ...
  // Conta ativa do chamador — automações são escopadas por conta, não pelo
  // criador (modelo multi-conta).
  ...
  if (!accountId) return NextResponse.json({ error: 'No active account' }, { status: 403 })
