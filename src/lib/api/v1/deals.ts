...
// it's a distinct resource with its own create path (leads are always
// new deals, never deduped like a contact).
// ============================================================
 ...
 * are resolved by re-querying after a failed insert — same backstop
 * pattern as `findOrCreateContact`.
 */
