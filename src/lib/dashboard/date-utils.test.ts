...
describe("mondayIndex", () => {
  it("maps Monday → 0 and Sunday → 6", () => {
    expect(mondayIndex(new Date(2026, 4, 18))).toBe(0); // Seg
    expect(mondayIndex(new Date(2026, 4, 19))).toBe(1); // Ter
    expect(mondayIndex(new Date(2026, 4, 23))).toBe(5); // Sáb
    expect(mondayIndex(new Date(2026, 4, 24))).toBe(6); // Dom
  });
