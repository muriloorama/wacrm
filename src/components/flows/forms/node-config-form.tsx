        ...
        <>
          ...
          <div>
            <label className="mb-1 block text-xs text-muted-foreground">
              Chave da variável (armazenada em flow_runs.vars; alfanumérico + underline)
            </label>
            <Input
            ...
            <p className="mt-1 text-[10px] text-muted-foreground">
              Use em textos e notas de transferência posteriores com{" "}
    ...
    case "end":
      return (
        <p className="text-xs text-muted-foreground">
          Nó final. Quando a execução chega neste nó, ela é marcada como
          concluída. Nenhuma configuração é necessária.
        </p>
      );
  }
}
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
        <TextRow
          label="Rótulo do botão que expande a lista (≤20 caracteres)"
        ...
        <div>
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="tag">Contato tem etiqueta</SelectItem>
