    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-border bg-card/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        <Metric
          ...
          tooltip="Contagem de todos os negócios deste funil que não estão marcados como Perdido. Negócios Ganhos continuam incluídos."
        />
        <Metric
          icon={<DollarSign className="h-4 w-4 text-primary" />}
          label="Valor do Funil"
          value={formatCurrency(stats.totalValue, defaultCurrency)}
          tooltip="Soma dos valores de todos os negócios deste funil, excluindo os negócios marcados como Perdido."
        />
        <Metric
          icon={<Target className="h-4 w-4 text-blue-400" />}
          label="Valor Médio do Negócio"
        ...
        <Metric
          ...
          tooltip="Receita esperada: o valor de cada negócio aberto × a probabilidade do seu estágio. Primeiro estágio ≈ 10%, os estágios avançam até 90%, Ganho = 100%. Negócios perdidos são excluídos."
        />
        <Metric
