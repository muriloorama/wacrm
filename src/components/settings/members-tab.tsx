...
const EDITABLE_ROLES: { value: AccountRole; label: string; hint: string }[] = [
  ...
  { value: 'agent', label: 'Agente', hint: 'Usa os recursos; sem configurações' },
  ...
  return (
    <section className="animate-in fade-in-50 space-y-6 duration-200">
      <SettingsPanelHead
        ...
        description="Pessoas com acesso a esta conta. Os papéis controlam o que cada colega pode fazer."
        action={
        ...
        <div>
          ...
          {invitations.length > 0 ? (
            <p className="mb-3 text-xs text-muted-foreground">
              Por segurança, a URL do convite em texto puro só é exibida
              uma vez, no momento da criação — para compartilhar de novo,
              revogue o convite abaixo e crie um novo.
            </p>
          ) : null}
        ...
        <DialogContent className="bg-popover border-border sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              ...
              nova conta pessoal no próximo login. O login dele não é
              excluído.
            </DialogDescription>
          </DialogHeader>
