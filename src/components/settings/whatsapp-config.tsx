...
export function WhatsAppConfig() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (data.registered === false && data.registration_error) {
        ...
        toast.success(
          'Credenciais salvas e verificadas. O registro de mensagens recebidas foi ignorado (sem PIN) — veja o Status de registro abaixo.',
          { duration: 10000 },
        );
        setPin('');
      } else {
  ...
  async function handleVerifyRegistration() {
    ...
    try {
      ...
      if (data.live) {
        ...
        toast.error(
          'O número não está totalmente registrado. Veja as verificações abaixo para saber qual passo falhou.',
          { duration: 8000 },
        );
      }
      if (accountId) await fetchConfig(accountId);
  ...
  async function handleReset() {
    if (!confirm('Isto vai excluir a configuração atual do WhatsApp para que você possa digitá-la novamente. Continuar?')) {
      return;
    }
    ...
    try {
      ...
      toast.success('Configuração apagada. Agora você pode digitar suas credenciais novamente.');
      setConfig(null);
      setPhoneNumberId('');
      setWabaId('');
      setAccessToken('');
      ...
      <div className="space-y-6">
        ...
        <Alert className="bg-card border-border">
          ...
          <AlertDescription className="text-muted-foreground">
            {connectionStatus === 'connected'
              ? 'Seu access token autentica com a Meta. Veja o Status de registro abaixo para saber se os webhooks estão realmente configurados.'
              : statusMessage ||
                'Configure suas credenciais da API da Meta abaixo para conectar sua conta comercial do WhatsApp.'}
          </AlertDescription>
        </Alert>
            ...
            <AlertDescription className="text-muted-foreground mt-2 text-xs leading-relaxed">
              {isRegistered ? (
                ...
                <>
                  ...
                  . Digite (ou corrija) o PIN de verificação em duas etapas abaixo e clique
                  em Salvar configuração para tentar de novo.
                </>
              ) : (
                <>
                  Este número foi salvo antes de o rastreamento de registro
                  existir, ou o registro foi ignorado. Digite o
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-muted-foreground">
              Digite as credenciais da sua WhatsApp Business API da Meta.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label className="text-muted-foreground">ID do número de telefone (Phone Number ID)</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label className="text-muted-foreground">ID da conta comercial do WhatsApp (WhatsApp Business Account ID)</Label>
              <Input
            ...
            <div className="space-y-2">
              <Label className="text-muted-foreground">Token de acesso permanente (Permanent Access Token)</Label>
            ...
            <div className="space-y-2">
              <Label className="text-muted-foreground">Token de verificação do webhook (Verify Token)</Label>
              <Input
              ...
              />
              <p className="text-xs text-muted-foreground">
                Um texto personalizado que você cria. Deve ser igual ao token que você definiu nas configurações de webhook da Meta.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Necessário apenas para configurar mensagens <strong className="text-muted-foreground">recebidas</strong>
                ...
                Os <strong className="text-muted-foreground">números de teste da Meta</strong> não têm
          ...
          <CardContent>
            <Accordion>
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Selecione &quot;Empresa&quot; como o tipo do app</li>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    <li>Acesse WhatsApp &gt; Configuração da API (API Setup)</li>
                    ...
                    <li>Gere um <strong className="text-foreground">Permanent Access Token</strong> em Configurações da Empresa &gt; Usuários do Sistema</li>
                  </ol>
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem className="border-border">
                ...
                <AccordionContent className="text-muted-foreground">
                  <ol className="list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Digite o mesmo <strong className="text-foreground">Verify Token</strong> que você definiu aqui</li>
