...
export function ProfileForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Upload a newly-staged image, if any (Backblaze B2 via presign).
      if (pendingAvatar) {
  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Seu perfil"
        description="Como você aparece no app. Seu avatar e nome aparecem no cabeçalho, na barra lateral e em qualquer lugar em que seus colegas de equipe o veem."
      />
        ...
        <Card>
          ...
          <div className="rounded-lg border border-border bg-muted p-4">
            ...
            <dl className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
              ...
              <div>
                <dt className="text-muted-foreground">Ingressou em</dt>
