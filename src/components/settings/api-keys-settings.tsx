      ...
      <SettingsPanelHead
        ...
        description={
          <>
            ...
            <code className="text-xs">/api/v1</code>) para você criar suas
        ...
        {createdKey ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                ...
                um lugar seguro — se você a perder, revogue-a e crie uma nova.
              </DialogDescription>
            </DialogHeader>
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Dê a ela o nome da integração que a usará e conceda apenas os
                escopos necessários.
              </DialogDescription>
            </DialogHeader>
